...
public class DecryptLSB {
    ...
    public static String Decrypt() throws IOException {
        ...
        try{
            ...
            Pixel[] pixels = EncryptLSB.GetPixelArray(image);
    ...
    private static char ConvertPixelsToCharacter(Pixel[] pixelsToRead){
        ...
        return  CovertBinaryValuesToCharacter(binaryValues);
    }
    ...
    private static char CovertBinaryValuesToCharacter(ArrayList<String> binaryValues) {
        StringBuilder endBinary = new StringBuilder("");
        int i;
        for (i = 0; i < binaryValues.size() - 1; i++) {
