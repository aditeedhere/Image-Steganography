...
public class EncryptLSB {
    public static void Encrypt(File imageFile, String message){
        ...
        try{
            ...
            EncodeMessageBinaryInPixel(pixels, messageBinary);
    ...
    public static Pixel[] GetPixelArray(BufferedImage imageToEncrypt){
    ...
    private static void EncodeMessageBinaryInPixel(Pixel[] pixels,String[] messageBinary){
        int pixelIndex = 0;
    ...
    private static String[] GetPixelsRGBBinary(Pixel pixel,char[] messageBinaryChars) throws ArrayIndexOutOfBoundsException{
